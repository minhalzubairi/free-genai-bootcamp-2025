...
- Study Progress
    ...
    - display a mastery progress in percentage e.g. 0%
- Quick Stats
    - success rate in percentage e.g. 80%
...
#### Purpose
The purpose of this page is to show a collection of study activities with a thumbnail and name of the activity, with buttons to either launch or view the study activity.
...
- Study Activity Card
    ...
    - the view button to launch view page to view more information about past study sessions for this study activity
...
Also after the form is submitted the page will redirect to the study sesssion show page
